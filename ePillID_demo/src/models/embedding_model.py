...
class EmbeddingModel(nn.Module):
    def __init__(self, network='resnet18', pooling='CBP', dropout_p=0.5, cont_dims=2048, pretrained=True, middle=1000, skip_emb=False):
        ...
        self.base_model = fast_MPN_COV_wrapper.get_model(arch=network, repr_agg=pooling, num_classes=cont_dims, dimension_reduction=cont_dims, pretrained=pretrained)
