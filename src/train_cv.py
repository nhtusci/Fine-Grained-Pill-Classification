...
# THAY BẰNG:
args.data_root_dir = os.path.abspath(args.data_root_dir)
logger.info(f"[INFO] data_root_dir (abs): {args.data_root_dir}")
args.folds_csv_dir = os.path.abspath(args.folds_csv_dir)
logger.info(f"[INFO] folds_csv_dir (abs): {args.folds_csv_dir}")
